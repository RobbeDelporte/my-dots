-- Animation curves and the animation tree.
-- Under hyprlang: `bezier = name, x0, y0, x1, y1` and
-- `animation = leaf, enabled, speed, curve[, style]` (positional).
-- Under Lua both are keyword tables — the curve is named by the `bezier` key.
...
hl.animation({ leaf = "layersIn",         enabled = true, speed = 2.5, bezier = "emphasizedDecel", style = "slide" })
...
hl.animation({ leaf = "workspaces",       enabled = true, speed = 2.5, bezier = "standard" })
